...
export class RangeMap {
	...
	splice(index: number, deleteCount: number, items: IItem[] = []): void {
        ...
        // 好像是把items插到index所在的位置，每一个item的range都是1
     ...
     * 
     * @note vscode用this.rangeMap.size来表示contentHeight, 见listView.ts line 260
	 */
	get size(): number {
		return this._size;
	}
     ...
     * @param position represents the value of a size position
	 */
